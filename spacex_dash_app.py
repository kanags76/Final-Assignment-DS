...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                {'label': 'Vandenberg SFB SLC-4E', 'value': 'VAFB SLC-4E'}],
                                value='ALL', placeholder=" Launch Sites", searchable=True
                                 ),
                                html.Br(),
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        names='Launch Site', 
        title='SpaceX Success Rate of All Sites')
    else:
        ...
        names='class',
        title='SpaceX Success Rate of {} Site'.format(entered_site))
    return fig
# TASK 4:
...
def get_scatter_chart(entered_site, slider_range):
    ...
    if entered_site == 'ALL':
        ...
        title='SpaceX Success Rate for Payload')
    else:
        # return the outcomes piechart for a selected site
        filtered_df=spacex_df.loc[spacex_df['Launch Site']==entered_site]
        fig = px.scatter(filtered_df, x= 'Payload Mass (kg)', y='class' ,
